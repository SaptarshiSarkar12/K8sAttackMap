...
class ImpactRemediationAdvisorTest {
    ...
    void shouldRecommendSecretRotationForSecret() {
        ...
        Assertions.assertTrue(action.toLowerCase().contains("rotat"), "Expected rotation advice for a Secret");
    }
    ...
    void shouldRecommendRbacAdviceForClusterRoleBinding() {
        ...
        Assertions.assertTrue(action.toLowerCase().contains("rbac") || action.toLowerCase().contains("privilege"),
    ...
    void shouldRecommendScopeAdviceForServiceAccount() {
        ...
        Assertions.assertTrue(action.toLowerCase().contains("scope") || action.toLowerCase().contains("service account"));
    }
    ...
    void shouldRecommendTightenAdviceForRole() {
        ...
        Assertions.assertTrue(action.toLowerCase().contains("role") || action.toLowerCase().contains("tighten")
    ...
    void shouldRecommendNetworkAdviceForIngress() {
        ...
        Assertions.assertTrue(action.toLowerCase().contains("network") || action.toLowerCase().contains("restrict"));
    }
    ...
    void shouldRecommendHardenAdviceForCriticalPod() {
        ...
        Assertions.assertTrue(action.toLowerCase().contains("harden") || action.toLowerCase().contains("segment"));
    }
    ...
    void shouldRecommendGeneralHardenAdviceForGenericPod() {
        ...
        String action = ImpactRemediationAdvisor.recommendAction(asset(pod));
        Assertions.assertTrue(action.toLowerCase().contains("harden") || action.toLowerCase().contains("security"));
    }
    ...
    void shouldRecommendAccessControlAdviceForConfigMap() {
        ...
        Assertions.assertTrue(action.toLowerCase().contains("access") || action.toLowerCase().contains("harden"));
    }
}